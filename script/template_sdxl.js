...
const checkpoints = [
    ...
    },
    {
        name: 'Imaginarium',
        type: '범용',
        model: 'https://civitai.com/models/249973/imaginarium',
        ipynb: 'imaginarium_xl_webui_colab',
        checkpoint: 'https://civitai.com/api/download/models/282087',
        checkpoint_file: 'imaginarium_v10.safetensors',
        bakedVAE: true,
    },
    {
        name: 'Starlight XL 星光 Animated',
        type: '3D',
        model: 'https://civitai.com/models/143043/starlight-xl-animated',
        ipynb: 'starlight_xl_webui_colab',
        checkpoint: 'https://civitai.com/api/download/models/182077?type=Model&format=SafeTensor&size=full&fp=fp16',
        checkpoint_file: 'starlight_XL_v30.safetensors',
        bakedVAE: true,
    },
    {
        name: 'Omnium',
        type: '범용',
        model: 'https://civitai.com/models/194245/omnium',
        ipynb: 'omnium_xl_webui_colab',
        checkpoint: 'https://civitai.com/api/download/models/235598?type=Model&format=SafeTensor&size=pruned&fp=fp16',
        checkpoint_file: 'omnium_xl_v11.safetensors',
        bakedVAE: true,
    },
    {
        name: 'AlbedoBase XL',
