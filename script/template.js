...
const checkpoints = [
    ...
    },
    {
        ...
        type: '실사',
        model: 'https://civitai.com/models/43331/majicmix-realistic',
        ipynb: 'majic_mix_realistic_v7_webui_colab',
        checkpoint: 'https://civitai.com/api/download/models/176425',
        checkpoint_file: 'majicMIX_realistic_v7.safetensors',
        bakedVAE: true,
    },
    {
...
async function make_readme2() {
    ...
    readmeText = readme.join('\n');
    fs.writeFileSync(`../COLAB_SD15.md`, readmeText);
    return true;
}
